...
} from '../../domain/drawing/drawingFunctions'
import { stylesheet } from 'typestyle'
import useMeasure from 'react-use-measure'
import { sizes } from '../../theme'
import type { NumericRange } from '../../app/measurement'
...
export function DrawingGrid() {
  ...
  const bordersWidth = borderWidth * drawingSize.width
  const cellSize = (bounds.width - bordersWidth) / drawingSize.width

  const widthRange = gridBoundsRange(drawingSize.width, borderWidth)
  const heightRange = gridBoundsRange(drawingSize.height, borderWidth)
