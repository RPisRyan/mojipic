...
type NoPayloadAction<A extends TypeDiscriminated> = NoExtraProperties<TypeDiscriminated, A>
...
export type StoreWithNamedDispatch<S, A extends TypeDiscriminated> = DispatchingStore<S, A> & {
