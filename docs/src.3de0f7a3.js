...
},{}],"kBdr":[function(require,module,exports) {
"use strict";
...
function useMeasure({
  ...
  const [bounds, set] = (0, _react.useState)({
    left: 0,
    top: 0,
    width: 0,
    height: 0,
  ...
  const [resizeChange, scrollChange] = (0, _react.useMemo)(() => {
    const callback = () => {
    ...
    return [resizeDebounce ? (0, _debounce.debounce)(callback, resizeDebounce) : callback, scrollDebounce ? (0, _debounce.debounce)(callback, scrollDebounce) : callback];
...
function stackStats(stack) {
  return {
    ...
    colCount: Math.max.apply(Math, stack.rows.map(function (it) {
      return it.cells.length;
    }))
  };
}
...
function PositionedDisplay(props) {
  var _a = (0, _reactUseMeasure.default)(),
      measureRef = _a[0],
      bounds = _a[1];

  var _ref = (0, _react.useRef)(undefined);
  ...
  (0, _react.useEffect)(function () {
    handlePaintActionRef.current = function (x, y) {
      if (!cellSize) {
        return;
      }
  ...
  (0, _react.useEffect)(function () {
    ...
    interactableRef.current = (0, _interactjs.default)(_ref.current).draggable({
      origin: 'self',
      ...
      listeners: {
        move: function move(event) {
          return handlePaintActionRef.current(event.client.x, event.client.y);
        }
      }
    }).pointerEvents({
      origin: 'self'
    }).on('tap', function (event) {
      return handlePaintActionRef.current(event.clientX, event.clientY);
    });
    return function () {
      var _a;
  ...
  var outerStyle = (0, _typestyle.style)({
    ...
    minWidth: '200px',
    width: '100%',
    height: (0, _csx.px)(rowCount * cellSize),
    touchAction: 'none'
  });
...
function renderCells(stack, cellSize) {
  ...
  var cellStyle = (0, _typestyle.style)({
    ...
    display: 'table-cell',
    textAlign: 'center',
    width: (0, _csx.percent)(100 / colCount),
    height: (0, _csx.percent)(100 / rowCount),
  ...
  var Cell = function Cell(props) {
    var _a = props.position,
        ...
        col = _a.col;
    var itemStyle = {
      left: (0, _csx.percent)(col / colCount * 100),
      top: (0, _csx.percent)(row / rowCount * 100)
    };
    return _react.default.createElement("div", {
      className: cellStyle,
      style: itemStyle
...
var defaultStack = {
  rows: defaultStackRaw.split('\n').map(function (rowChars) {
    return {
      cells: splitter.splitGraphemes(rowChars.trim()).map(function (character) {
        return {
          character: character
        };
      })
...
function Editor(props) {
    ...
    if (event.character !== brush) {
      setStack(function (state) {
        return (0, _immer.default)(state, function (draft) {
          var row = draft.rows[event.position.row];
          var cell = row && row.cells[event.position.col];
  ...
  }, "Copy to clipboard", copied && _react.default.createElement("span", null, "- done!")), _react.default.createElement("button", {
    onClick: handleExpandClick
  }, "Expand"))), _react.default.createElement("h3", null, "Brush"), _react.default.createElement(_BrushEntry.default, {
    brush: brush,
    setBrush: setBrush
